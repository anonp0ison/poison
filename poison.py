...
configFile = installDir + "/poison.cfg"
print(installDir)
config = ConfigParser.RawConfigParser()
config.read(configFile)

toolDir = installDir + config.get('poison', 'toolDir')
logDir = installDir + config.get('poison', 'logDir')
yes = config.get('poison', 'yes').split()
...
'''
def agreement():
    while not config.getboolean("poison", "agreement"):
        clearScr()
        print(termsAndConditions)
        agree = raw_input("You must agree to our terms and conditions first (Y/n) ").lower()
        if agree in yes:
            config.set('poison', 'agreement', 'true')

class poison:
    def __init__(self):
        clearScr()
        self.createFolders()
        print (poisonlogo + color.RED + '''
       }--------------{+} Coded By anonp0ison {+}--------------{
       }--------{+}  GitHub.com/anonp0ison/poison {+}--------{
    ''' + color.END + '''
    ...
    def githubContributors(self):
     ...
     ╚██████╗╚██████╔╝██║ ╚████║   ██║   ██║  ██║██║██████╔╝███████║
      ╚═════╝ ╚═════╝ ╚═╝  ╚═══╝   ╚═╝   ╚═╝  ╚═╝╚═╝╚═════╝ ╚══════╝
     ''')
        contributorsURL = 'https://api.github.com/repos/anonp0ison/poison/contributors'
    ...
    def update(self):
        os.system("git clone --depth=1 https://github.com/anonp0ison/poison.git")
        os.system("cd poison && bash ./update.sh")
        os.system("poison")
...
class sniffingSpoofingMenu:
    ...
    def __init__(self):
        ...
        choice6 = raw_input(poisonPrompt)
        clearScr()
        if choice6 == "1":
            setoolkit()
        elif choice6 == "2":
...
class webHackingMenu:
    ...
    def __init__(self):
        ...
        print("   {99}-Back To Main Menu \n")
        choiceweb = raw_input(poisonPrompt)
        clearScr()
        if choiceweb == "1":
            maine()
        elif choiceweb == "2":
...
class postExploitationMenu:
    ...
    def __init__(self):
        ...
        choice11 = raw_input(poisonPrompt)
        clearScr()
        if choice11 == "1":
            sitechecker()
        elif choice11 == "2":
...
class informationGatheringMenu:
    ...
    def __init__(self):
        ...
        print("  {8}--Crips\n  ")
        print("  {99}-Back To Main Menu \n")
        choice2 = raw_input(poisonPrompt)
        clearScr()
        if choice2 == "1":
            nmap()
        elif choice2 == "2":
...
class crips:
    ...
    def __init(self):
        ...
        self.gitRepo = "https://github.com/anonp0ison/Crips.git"
...
class wirelessTestingMenu:
    ...
    def __init__(self):
        ...
        choice4 = raw_input(poisonPrompt)
        clearScr()
        if choice4 == "1":
            reaver()
        elif choice4 == "2":
...
class exploitationToolsMenu:
    ...
    def __init__(self):
        ...
        choice5 = raw_input(poisonPrompt)
        clearScr()
        if choice5 == "1":
            atscan()
        elif choice5 == "2":
